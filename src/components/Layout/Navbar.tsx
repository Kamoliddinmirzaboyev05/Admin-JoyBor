                ...
                <>
                  ...
                  >
                    ...
                    {unreadCount === 0 ? (
                      ...
                      // Faqat o'qilmagan bildirishnomalarni ko'rsatish
                      displayNotifications
                        .filter((n: any) => !n.read && !n.is_read)
                        .slice(0, 5)
                        .map((notification: any) => (
                          <motion.div
                            ...
                            className="px-4 py-3 cursor-pointer border-l-4 border-primary-500 bg-primary-50 dark:bg-primary-900/20"
                          >
